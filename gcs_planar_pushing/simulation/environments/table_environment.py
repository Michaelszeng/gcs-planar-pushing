...
from gcs_planar_pushing.simulation.controllers.desired_planar_position_source_base import (
    DesiredPlanarPositionSourceBase,
)
from gcs_planar_pushing.simulation.controllers.iiwa_hardware_station import (
    IiwaHardwareStation,
)
from gcs_planar_pushing.simulation.controllers.robot_system_base import (
    RobotSystemBase,
)
...
from gcs_planar_pushing.simulation.state_estimators.state_estimator import (
    StateEstimator,
)
from gcs_planar_pushing.simulation.systems.rigid_transform_to_planar_pose_vector_system import (
...
class TableEnvironment:
    def __init__(
        ...
        if sim_config.use_hardware:
            from gcs_planar_pushing.simulation.sensors.optitrack import (
